...
//Funktion in welcher Service-Informationen angezeigt werden
    ...
    <div>
      <div className="service_layout">
        ...
        <p className="service_content">
          Kaffee erfreut uns doch erst, wenn wir ihn genießen. Deshalb sollte er
          auch so schnell wie möglich bei Ihnen Zuhause sein!
        </p>
        <p className="service_content">
